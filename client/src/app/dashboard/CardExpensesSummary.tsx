...
// }
// const colors = ["#00C495", "#0088FE", "#FFBB28" ]
...
//             </ResponsiveContainer>
//             <div className="absolute top-1/2 left-1/2 transform -translate-y-1/2 text-center">
    ...
    <div className="row-span-3 bg-white shadow-md rounded-2xl flex flex-col justify-between">
      {isLoading ? (
        ...
        <>
          ...
          <div className="xl:flex justify-between pr-7">
            {/* Pie Chart Section */}
            <div className="relative flex justify-center items-center basis-3/5">
