...
const StatCard = ({
    ...
    return (
      <div className='md:row-span-1 xl:row-span-2 row-span-3 bg-white col-span-1 shadow-md rounded-2xl flex flex-col justify-between'>
          <div>
...
<div className="flex mb-6 items-center justify-around gap-4 px-5">
    ...
    <React.Fragment key={index}>
        <div className="flex items-center justify-between my-4">
            ...
            <div className="flex items-center"><detail.IconComponent className={`w-4 h-4 mr-1 ${getChangeColor(detail.changePercentage)}`}>
